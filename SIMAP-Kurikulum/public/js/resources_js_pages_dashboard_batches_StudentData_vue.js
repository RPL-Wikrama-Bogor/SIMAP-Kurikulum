(self["webpackChunk"] = self["webpackChunk"] || []).push([["resources_js_pages_dashboard_batches_StudentData_vue"],{
...
/***/ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    "select2": (vue_select__WEBPACK_IMPORTED_MODULE_2___default()),
  ...
  computed: _objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_4__.mapState)(['errorMessage', 'errors', 'isLoading'])),
  methods: _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_4__.mapActions)('majors', ['allData'])), (0,vuex__WEBPACK_IMPORTED_MODULE_4__.mapActions)('studentGroups', ['detailStudentGroup', 'edit', 'deleteStudentGroupCascade'])), (0,vuex__WEBPACK_IMPORTED_MODULE_4__.mapActions)('batches', ['show'])), (0,vuex__WEBPACK_IMPORTED_MODULE_4__.mapActions)('students', ['create', 'index', 'studentDetail', 'update', 'deleteStudentUser'])), {}, {
    ...
    showStudentGroup: function showStudentGroup(id) {
      var _this2 = this;

      this.detailStudentGroup(id).then(function (result) {
        _this2.editForm = result;
        _this2.studentGroup = result.name;
      });
    },
    editStudentGroup: function editStudentGroup() {
      var _this3 = this;
      ...
      this.edit(payload).then(function (result) {
        _this3.modalEdit = false;

        _this3.showStudentGroup(result.id);
      });
    },
    showModalDeleteStudentGroup: function showModalDeleteStudentGroup() {
      this.modalEdit = false;
      this.modalDeleteStudentGroup = true;
    },
    deleteStudentGroup: function deleteStudentGroup() {
      var _this4 = this;

      var payload = this.$route.params.group;
      this.deleteStudentGroupCascade(payload).then(function (result) {
        _this4.modalDeleteStudentGroup = false;
      });
    },
    showBatch: function showBatch(id) {
      var _this5 = this;

      this.show(id).then(function (result) {
        _this5.batch = result;
        _this5.batchName = result.batch_name;
      });
    },
    getStudents: function getStudents(payload) {
      ...
      this.index(payload).then(function (result) {
        _this6.rows = result.data;
        _this6.pages.total = result.total;
        _this6.pages.per_page = result.per_page;
        _this6.pages.from = result.from;
        _this6.pages.to = result.to;
        _this6.pages.current_page = result.current_page;
        _this6.pages.last_page = result.last_page;
      });
    },
    ...
    showModalDeleteStudent: function showModalDeleteStudent() {
    ...
    showStudent: function showStudent(id) {
      ...
      this.studentDetail(id).then(function (result) {
        _this7.studentEditForm = result;
        _this7.modalEditStudent = true;
      });
    },
    editStudent: function editStudent() {
      ...
      var payload = {
        id: this.studentEditForm.id,
        data: this.studentEditForm
      };
      this.update(payload).then(function (result) {
        _this8.modalEditStudent = false;

        _this8.getStudents(_this8.payloadGet);
      });
    },
    addStudent: function addStudent() {
      var _this9 = this;

      this.create(this.studentAddForm).then(function (result) {
        _this9.studentAddForm.name = null;
        _this9.studentAddForm.nis = null;
        _this9.studentAddForm.nisn = null;
        _this9.studentAddForm.jk = null;
        _this9.modalAddStudent = false;

        _this9.getStudents(_this9.payloadGet);
      });
    },
    deleteStudent: function deleteStudent() {
      var _this10 = this;

      var payload = this.studentEditForm.id;
      this.deleteStudentUser(payload).then(function (result) {
        _this10.modalDeleteStudentGroup = false;
        _this10.modalDeleteStudent = false;

        _this10.getStudents(_this10.payloadGet);
      });
    }
  })
});
...
/***/ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=style&index=0&id=02f0bc2a&scoped=true&lang=css&":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=style&index=0&id=02f0bc2a&scoped=true&lang=css& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/***/ ((module, __webpack_exports__, __webpack_require__) => {
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "\n.form-group[data-v-02f0bc2a] {\n    margin-bottom: 10px;\n}\n.btn-outline-muted[data-v-02f0bc2a] {\n    color: #535353;\n    border-color: #B4ADAD;\n    border-radius: 0px !important;\n}\n.btn-secondary[data-v-02f0bc2a] {\n    margin-left: 10px !important;\n}\n\n/* table */\n.card[data-v-02f0bc2a] {\n    position: relative;\n    display: flex;\n    flex-direction: column;\n    min-width: 0;\n    background-color: #fff;\n    border: 1px solid #d2d2dc;\n    border-radius: 0;\n}\n.card .card-title[data-v-02f0bc2a] {\n    color: #000;\n    margin-bottom: 10px;\n    text-transform: capitalize;\n    font-size: 1rem;\n    font-weight: 600;\n}\n.card .card-description[data-v-02f0bc2a] {\n    color: #B4ADAD;\n    font-size: 0.8rem;\n    margin-bottom: 0.5rem;\n}\n.badge[data-v-02f0bc2a] {\n    border-radius: 0;\n    font-size: 14px;\n    line-height: 1;\n    padding: 0.3rem 0.5rem;\n    font-weight: normal;\n    cursor: pointer;\n}\n@media (max-width: 575px) {\n.btn[data-v-02f0bc2a], .input-text[data-v-02f0bc2a] {\n        font-size: 0.8rem !important;\n}\n.btn[data-v-02f0bc2a] {\n        padding: 0.2rem 0.5rem !important;\n}\n}\n", ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_StudentData_vue_vue_type_style_index_0_id_02f0bc2a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./StudentData.vue?vue&type=style&index=0&id=02f0bc2a&scoped=true&lang=css& */ "./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=style&index=0&id=02f0bc2a&scoped=true&lang=css&");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_StudentData_vue_vue_type_style_index_0_id_02f0bc2a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_1__["default"], options);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _StudentData_vue_vue_type_template_id_02f0bc2a_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./StudentData.vue?vue&type=template&id=02f0bc2a&scoped=true& */ "./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=template&id=02f0bc2a&scoped=true&");
/* harmony import */ var _StudentData_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./StudentData.vue?vue&type=script&lang=js& */ "./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=script&lang=js&");
/* harmony import */ var _StudentData_vue_vue_type_style_index_0_id_02f0bc2a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./StudentData.vue?vue&type=style&index=0&id=02f0bc2a&scoped=true&lang=css& */ "./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=style&index=0&id=02f0bc2a&scoped=true&lang=css&");
...
var component = (0,_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  _StudentData_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _StudentData_vue_vue_type_template_id_02f0bc2a_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render,
  _StudentData_vue_vue_type_template_id_02f0bc2a_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  "02f0bc2a",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/pages/dashboard/batches/StudentData.vue"
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (component.exports);
...
/***/ "./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=script&lang=js&":
/*!***************************************************************************************!*\
  !*** ./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=script&lang=js& ***!
  \***************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_StudentData_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./StudentData.vue?vue&type=script&lang=js& */ "./node_modules/babel-loader/lib/index.js??clonedRuleSet-5[0].rules[0].use[0]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=script&lang=js&");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_clonedRuleSet_5_0_rules_0_use_0_node_modules_vue_loader_lib_index_js_vue_loader_options_StudentData_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=style&index=0&id=02f0bc2a&scoped=true&lang=css&":
/*!***********************************************************************************************************************!*\
  !*** ./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=style&index=0&id=02f0bc2a&scoped=true&lang=css& ***!
  \***********************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_laravel_mix_node_modules_css_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_dist_cjs_js_clonedRuleSet_9_0_rules_0_use_2_node_modules_vue_loader_lib_index_js_vue_loader_options_StudentData_vue_vue_type_style_index_0_id_02f0bc2a_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./StudentData.vue?vue&type=style&index=0&id=02f0bc2a&scoped=true&lang=css& */ "./node_modules/style-loader/dist/cjs.js!./node_modules/laravel-mix/node_modules/css-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[1]!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-9[0].rules[0].use[2]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=style&index=0&id=02f0bc2a&scoped=true&lang=css&");
...
/***/ "./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=template&id=02f0bc2a&scoped=true&":
/*!*********************************************************************************************************!*\
  !*** ./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=template&id=02f0bc2a&scoped=true& ***!
  \*********************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "render": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_StudentData_vue_vue_type_template_id_02f0bc2a_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render),
/* harmony export */   "staticRenderFns": () => (/* reexport safe */ _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_StudentData_vue_vue_type_template_id_02f0bc2a_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns)
/* harmony export */ });
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_StudentData_vue_vue_type_template_id_02f0bc2a_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./StudentData.vue?vue&type=template&id=02f0bc2a&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=template&id=02f0bc2a&scoped=true&");
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=template&id=02f0bc2a&scoped=true&":
/*!************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib/index.js??vue-loader-options!./resources/js/pages/dashboard/batches/StudentData.vue?vue&type=template&id=02f0bc2a&scoped=true& ***!
  \************************************************************************************************************************************************************************************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
    ...
    !_vm.isLoading
      ? _c(
          ...
          [
            _c("nav", { attrs: { "aria-label": "breadcrumb" } }, [
              _c("ol", { staticClass: "breadcrumb" }, [
                    ...
                    _c(
                      "router-link",
                      {
                        attrs: {
                          to: {
                            name: "student_groups",
                            params: { page: 4, batch: _vm.$route.params.batch },
                          },
                        },
                      },
                      [
                ...
                _c(
                  ...
                  [
                    _vm._v(_vm._s(_vm.studentGroup) + " "),
            ...
            _c(
              "div",
              { staticClass: "row mt-2 d-flex justify-content-center" },
              [
                _c("div", { staticClass: "col-12 grid-margin stretch-card" }, [
                  _c("div", { staticClass: "card" }, [
                    _c("div", { staticClass: "card-body" }, [
                      _c("h4", { staticClass: "card-title" }, [
                        _vm._v("Data siswa rombel " + _vm._s(_vm.studentGroup)),
                      ]),
                      _vm._v(" "),
            ...
            _vm.modalEdit
              ? _c(
                  "modal",
                  {
                    attrs: { action: _vm.editStudentGroup },
                    on: {
                  ...
                  [
                    ...
                    _c("div", { attrs: { slot: "body" }, slot: "body" }, [
                      ...
                      _c(
                        ...
                        [
                          ...
                          _vm._v(" "),
                          _c("select2", {
                            class: { "is-invalid": _vm.errors.major_id },
                            attrs: {
                              options: _vm.majors,
                            ...
                            model: {
                              value: _vm.editForm.major_id,
                              callback: function ($$v) {
                                _vm.$set(_vm.editForm, "major_id", $$v)
                              },
                              expression: "editForm.major_id",
                            },
                          }),
                          _vm._v(" "),
                          _vm.errors.major_id
                      ...
                      _c("div", { staticClass: "form-group" }, [
                        ...
                        _c("input", {
                          ...
                          attrs: { type: "text", placeholder: "RPL XII-2" },
                    ...
                    _c(
                      "button",
                      {
                        ...
                        on: { click: _vm.showModalDeleteStudentGroup },
                        slot: "button",
                      },
                      [_vm._v("Hapus")]
                    ),
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm.modalDeleteStudentGroup
              ? _c(
                  "modal",
                  {
                    attrs: { deleteOpt: _vm.deleteStudentGroup },
                    on: {
                      close: function ($event) {
                        _vm.modalDeleteStudentGroup = false
                      },
                    },
                  },
                  [
                    ...
                    _c("div", { attrs: { slot: "body" }, slot: "body" }, [
                      _c("span", [
                        ...
                        _vm._v(". Yakin tetap menghapus data "),
                        _c("b", { staticClass: "text-capitalize" }, [
                          _vm._v(_vm._s(_vm.studentGroup)),
                        ]),
                        _vm._v("?"),
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm.modalEditStudent
              ? _c(
                  "modal",
                  {
                    attrs: { action: _vm.editStudent },
                    on: {
                      close: function ($event) {
                        _vm.modalEditStudent = false
                      },
                    },
                  },
                  [
                    ...
                    _c("div", { attrs: { slot: "body" }, slot: "body" }, [
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.studentEditForm.name,
                              expression: "studentEditForm.name",
                            },
                          ],
                          staticClass: "form-control",
                          class: { "is-invalid": _vm.errors.name },
                          attrs: { type: "text", placeholder: "Levi Ackerman" },
                          domProps: { value: _vm.studentEditForm.name },
                          on: {
                            input: function ($event) {
                              if ($event.target.composing) {
                                return
                      ...
                      _vm._v(" "),
                      _c("div", { staticClass: "form-group" }, [
                        _c("label", { staticClass: "mb-2" }, [_vm._v("NIS")]),
                        _vm._v(" "),
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.studentEditForm.nis,
                              expression: "studentEditForm.nis",
                            },
                          ],
                          staticClass: "form-control",
                          class: { "is-invalid": _vm.errors.nis },
                          attrs: { type: "number" },
                          domProps: { value: _vm.studentEditForm.nis },
                          on: {
                            input: function ($event) {
                              if ($event.target.composing) {
                                return
                      ...
                      _vm._v(" "),
                      _c("div", { staticClass: "form-group" }, [
                        _c("label", { staticClass: "mb-2" }, [_vm._v("NISN")]),
                        _vm._v(" "),
                        _c("input", {
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.studentEditForm.nisn,
                              expression: "studentEditForm.nisn",
                            },
                          ],
                          staticClass: "form-control",
                          class: { "is-invalid": _vm.errors.nisn },
                          attrs: { type: "number" },
                          domProps: { value: _vm.studentEditForm.nisn },
                          on: {
                            input: function ($event) {
                              if ($event.target.composing) {
                                return
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.studentEditForm.jk,
                                expression: "studentEditForm.jk",
                              },
                            ],
                    ...
                    _c(
                      "button",
                      {
                        staticClass: "btn btn-outline-danger",
                        attrs: { slot: "button", type: "button" },
                        on: { click: _vm.showModalDeleteStudent },
                        slot: "button",
                      },
                      [_vm._v("Hapus")]
                    ),
            ...
            _vm.modalAddStudent
              ? _c(
                  "modal",
                  {
                    attrs: { action: _vm.addStudent },
                    on: {
                      close: function ($event) {
                        _vm.modalAddStudent = false
                      },
                    },
                  },
                  [
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.studentAddForm.name,
                              expression: "studentAddForm.name",
                            },
                          ],
                          staticClass: "form-control",
                          class: { "is-invalid": _vm.errors.name },
                          attrs: { type: "text", placeholder: "Levi Ackerman" },
                          domProps: { value: _vm.studentAddForm.name },
                          on: {
                            input: function ($event) {
                              if ($event.target.composing) {
                                return
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.studentAddForm.nis,
                              expression: "studentAddForm.nis",
                            },
                          ],
                          staticClass: "form-control",
                          class: { "is-invalid": _vm.errors.nis },
                          attrs: { type: "number" },
                          domProps: { value: _vm.studentAddForm.nis },
                          on: {
                            input: function ($event) {
                              if ($event.target.composing) {
                                return
                          ...
                          directives: [
                            {
                              name: "model",
                              rawName: "v-model",
                              value: _vm.studentAddForm.nisn,
                              expression: "studentAddForm.nisn",
                            },
                          ],
                          staticClass: "form-control",
                          class: { "is-invalid": _vm.errors.nisn },
                          attrs: { type: "number" },
                          domProps: { value: _vm.studentAddForm.nisn },
                          on: {
                            input: function ($event) {
                              if ($event.target.composing) {
                                return
                            ...
                            directives: [
                              {
                                name: "model",
                                rawName: "v-model",
                                value: _vm.studentAddForm.jk,
                                expression: "studentAddForm.jk",
                              },
                            ],
                            staticClass: "form-check-input",
                            attrs: {
                  ...
                  [
                    ...
                    _c("div", { attrs: { slot: "body" }, slot: "body" }, [
                      _c("span", [
                        ...
                        _c("b", { staticClass: "text-capitalize" }, [
                          _vm._v(
                            _vm._s(_vm.studentEditForm.name) +
                              " - " +
                              _vm._s(_vm.studentEditForm.nis)
                          ),
                        ]),
                        _vm._v(" akan "),
                        _c("b", [_vm._v("terhapus")]),
                        _vm._v(" dan "),
                        _c("b", [_vm._v("tidak dapat diakses kembali")]),
                        _vm._v(". Yakin tetap menghapus siswa "),
                        _c("b", { staticClass: "text-capitalize" }, [
                          _vm._v(
                            _vm._s(_vm.studentEditForm.name) +
                              " - " +
